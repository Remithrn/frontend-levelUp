...
const LoginComponent = () => {
  ...
  const reachGoogle = () => {
    ...
    const callBackURI = `${window.location.origin}${window.location.pathname.replace(/\/login$/, "")}/`;
    ...
    <div className="flex justify-center mt-2">
      <Card className="w-2/3">
        <CardBody>
          ...
          <Divider />
          <h3 className="text-default-500 text-center mb-1 font-bold text-2xl">
            Login
          </h3>

          {errors.non_field_errors && (
            <p color="error" className="text-center mb-4 text-red-500">
              {errors.non_field_errors}
            </p>
          )}
          ...
          <div className="d-grid gap-2 mt-2">
            <Button className="btn-custom-blue" size="lg" onClick={reachGoogle}>
              Login With Google
            </Button>
          </div>
